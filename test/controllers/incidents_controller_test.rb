...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { escalation_policy: @incident.escalation_policy, impact_index: @incident.impact_index, initial_service_rating: @incident.initial_service_rating, service_impact: @incident.service_impact, time_impact: @incident.time_impact, user_id: @incident.user_id }
    end
